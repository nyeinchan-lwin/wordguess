...
const TRANSLATIONS = {
  en: {
    ...
    popularity_group: 'Themes by games played',
    no_games_yet:  'No games played yet.',
    theme_custom:  'Custom',
    custom_words:  'Custom word list',
    custom_import: 'Import .txt',
    custom_clear:  'Clear',
    custom_none:   'None loaded. A plain text file, one word per line.',
    custom_loaded: '{n} words loaded ({skipped} skipped).',
    custom_empty:  'No usable words in that file — they must be 4 to 7 letters, A-Z only.',
    theme_halloween: 'Halloween',
    theme_winter:  'Winter',
    haptics:       'Vibration',
    install:       'Install',
    install_hint:  'Add WordGuess to your home screen',
    n_words:       '{n} words',
    one_word:      '1 word',
    no_words:      'no words',
    difficulty_group: 'Letter difficulty',
    diff_any:      'Any',
    diff_easier:   'Easier letters',
    diff_trickier: 'Trickier letters',
    timed:         'Timed Mode',
    timed_mode:    'Timed',
    timed_solved:  'solved',
  ...
  my: {
    ...
    avg_time:      'ပျမ်းမျှ အချိန်',
    popularity:    'အများဆုံး ကစားသော',
    popularity_group: 'ကစားထားသော အလိုက် အခေါင်းစဉ်များ',
    no_games_yet:  'ကစားထားခြင်း မရှိသေးပါ။',
    theme_custom:  'ကိုယ်ပိုင်',
    custom_words:  'ကိုယ်ပိုင် စကားလုံးစာရင်း',
    custom_import: '.txt ဖိုင် ထည့်ရန်',
    custom_clear:  'ရှင်းရန်',
    custom_none:   'မရှိသေးပါ။ တစ်ကြောင်းလျှင် စကားလုံးတစ်လုံး စာသားဖိုင်။',
    custom_loaded: 'စကားလုံး {n} လုံး ထည့်ပြီး ({skipped} လုံး ချန်ထား)။',
    custom_empty:  'အသုံးပြုနိုင်သော စကားလုံး မရှိပါ — အက္ခရာ ၄ မှ ၇ လုံး၊ A-Z သာ။',
    theme_halloween: 'သရဲပွဲတော်',
    theme_winter:  'ဆောင်းရာသီ',
    haptics:       'တုန်ခါမှု',
    install:       'ထည့်သွင်းရန်',
    install_hint:  'WordGuess ကို ပင်မစခရင်တွင် ထည့်ပါ',
    n_words:       'စကားလုံး {n} လုံး',
    one_word:      'စကားလုံး ၁ လုံး',
    no_words:      'စကားလုံး မရှိ',
    difficulty_group: 'အက္ခရာ အခက်အခဲ',
    diff_any:      'အားလုံး',
    diff_easier:   'လွယ်သော အက္ခရာ',
    diff_trickier: 'ခက်သော အက္ခရာ',
